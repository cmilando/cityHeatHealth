...
This package comes pre-loaded with sample datasets of each type so each of these methods can be explored. See below for starter code for each type of analysis.
