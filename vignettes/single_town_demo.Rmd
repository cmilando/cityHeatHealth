...
The functionality above is what is encapsulated in the `condPois` function. This is one of the chief innovations of this package. Starting from a messy exposure and outcome dataset, we can quickly estimate heat-health impacts in 3 lines.
...
### Basic DLNM (using `cityHeatHealth` functions in `STAN`)
