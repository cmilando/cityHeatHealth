...
Now, quickly get a `condPois_single()` and `condPois_2stage()` objects to use in testing:
exposures
```{r ee}
...
Some plot functions exist but you probably want to summarize to larger spatial units so the plots are manageable
